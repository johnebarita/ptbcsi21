...
class TaxDeductionSeeder extends Seeder
{
    public function run()
    {
        $this->db->table('tax_deductions')->insert(['from'=>'2021-01-01 00:00:00','type'=>'pag-ibig','lowest'=>1,'highest'=>1500-0.01,'employer_share'=>1,'employee_share'=>2]);
        $this->db->table('tax_deductions')->insert(['from'=>'2021-01-01 00:00:00','type'=>'pag-ibig','lowest'=>1500,'highest'=>100000,'employer_share'=>2,'employee_share'=>2]);
        $this->db->table('tax_deductions')->insert(['from'=>'2021-01-01 00:00:00','type'=>'philhealth','lowest'=>10000,'highest'=>70000,'employer_share'=>1.75,'employee_share'=>1.75]);
