<div class="container-fluid">
    ...
    <?php use App\Models\Eloquent\Leave;
    use Carbon\Carbon;
            ...
            <div>
                ...
                <div class="flex">
                    <div class="form-group flex ml-auto mb-0">
                        <label class="pl-3 ">Leave:<span class="text-primary">____</span class=text-primary></label>
                        <label class="pl-3 ">Absent:<span class="text-primary">____</span class=text-primary></label>
                        <label class="pl-3 ">Over Time:<span class="text-primary">____</span class=text-primary></label>
                        <label class="pl-3 ">Under Time:<span
                                    class="text-primary">____</span class=text-primary></label>
                        <label class="pl-3 ">Late:<span class="text-primary">____</span class=text-primary></label>
                    </div>
                </div>
            </div>
            <div>
                <table class="dtr-table text-center w-100">
                    ...
                    foreach ($periods as $period):
                        ...
                        $time_sheet = (count($time_sheets) ? $time_sheets->where('date', '=', $date)->first() : null);
