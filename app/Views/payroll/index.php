<div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <div>
                <div style="height:60vh;width:100%;" class="payroll-table-container">
                    <table id="payroll-table" class=" text-center table payroll-table table-bordered table-condensed ">
                        <thead>
                        <tr>
                            <th rowspan="2">No.</th>
                            <th>Employee</th>
                        ...
                        foreach ($positions as $position) {
                            ...
                            <?php foreach ($position->employees as $employee) {
                                ...
                                <tr class="<?= ($employee->is_fixed_salary == 1 ? 'fixed-salary' : '') ?>">
                                    <th><?= $count++; ?></th>
                                    <th><?= strtoupper($employee->lastname . ' ' . $employee->firstname); ?> <span
                                                class="font-italic font-weight-lighter"><?= ($employee->is_fixed_salary == 1 ? '(Fixed-salary)' : '') ?></span>
                                    </th>
                                    ...
                                    <td><?= ($payroll->rd_sunday_pay != 0 ? $payroll->rd_sunday_pay : ''); ?></td>
                                    <td><?= ($payroll->rd_regular_pay != 0 ? $payroll->rd_regular_pay : ''); ?></td>
                                    <td><?= ($payroll->rd_special_pay != 0 ? $payroll->rd_special_pay : ''); ?></td>
                                    <td><?= ($payroll->rd_double_pay != 0 ? $payroll->rd_double_pay : ''); ?></td>
                                    ...
                                    <td><?= ($payroll->nd_regular_pay != 0 ? $payroll->nd_regular_pay : ''); ?></td>
                                    <td><?= ($payroll->nd_special_pay != 0 ? $payroll->nd_special_pay : ''); ?></td>
                                    <td><?= ($payroll->nd_double_pay != 0 ? $payroll->nd_double_pay : ''); ?></td>
                                    ...
                                    <td>
                                        <div class="flex ml-2 mr-2">
                                            <a href="#" data-id="<?=$payroll->id?>" class="btn btn-primary btn-circle btn-sm btn-xs edit_payroll">
    ...
    <?= $this->include('payroll\partials\edit_payroll') ?>
</div>
