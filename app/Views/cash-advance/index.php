<div class="container-fluid">
            ...
            <div class="flex">
                <div class="table-responsive" style="width: 65% !important;">
                    ...
                    <table class="ca-table table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                        <?php foreach ($cash_advances as $cash_advance): ?>
                            <tr data-id="<?= $cash_advance->id ?>" data-json='<?=$cash_advance->cash_advance_details?>'>
    ...
    <?= $this->include('cash-advance\partials\add_cash_advance') ?>
    <?= $this->include('cash-advance\partials\edit_cash_advance') ?>
</div>