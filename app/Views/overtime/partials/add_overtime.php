<div class="modal fade" id="add_overtime" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="<?= route_to('overtime.create')?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="overtime_in" name="overtime_in" value="17:00" ="" required="">
                    </div>

                    <div class="form-group">
                        <label for="overtime_out">Overtime Out</label>
                        <input type="time" class="form-control" id="overtime_out" name="overtime_out" value="20:00" ="" required="">
                    </div>
                    <div class="form-group">
