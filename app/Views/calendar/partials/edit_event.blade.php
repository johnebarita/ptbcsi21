            ...
            <div class="modal-body">
                <form action="{{route_to('calendar.create')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="start" class="form-control" name="start" value="2020-10-15" required>
                    </div>

                    <div class="form-group">
                        <label for="end">End</label>
                        <input type="date" id="end" class="form-control" name="end" value="2020-10-15" required>
                    </div>
                    <div class="form-group">
