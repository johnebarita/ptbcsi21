                ...
                <table class="position-table table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    foreach ($positions as $position){?>
                        <tr>
                            ...
                            <td><?=$position->rate;?></td>
                            <td data-id ="<?=$position->schedule->id?>"><?= Time::createFromFormat('G:i', $position->schedule->time_in)->format('h:i A').' - '.
                                    Time::createFromFormat('G:i', $position->schedule->time_out)->format('h:i A');?>
                            </td>
                            <td>
                                <div class="flex">
                                    <a href="#" data-id="<?=$position->id?>" title="test" class="btn btn-success btn-circle btn-sm m-auto edit_position">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="#" data-id="<?=$position->id?>" class="btn btn-danger btn-circle btn-sm m-auto delete_position">
