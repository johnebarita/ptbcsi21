<div class="container-fluid">
            ...
            <div class="table-responsive">
                <table class="employee-table table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <?=Carbon::createFromFormat('G:i',$employee->position->schedule->time_in)->format('h:i A').' - '.
                               Carbon::createFromFormat('G:i',$employee->position->schedule->time_out)->format('h:i A')?>
                        </td>
    ...
    <?= $this->include('employee\partials\add_employee') ?>
</div>