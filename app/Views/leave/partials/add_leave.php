            ...
            <div class="modal-body">
                <form action="<?=route_to('leave.create')?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="request_start" class="form-control" name="request_start" value="<?=\Carbon\Carbon::now()->format('Y-m-d')?>" required>
                    </div>

                    <div class="form-group">
                        <label for="request_end">Date From</label>
                        <input type="date" id="request_end" class="form-control" name="request_end" value="<?=\Carbon\Carbon::now()->format('Y-m-d')?>" required>
                    </div>
