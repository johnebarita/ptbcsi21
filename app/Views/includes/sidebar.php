...
<ul class="navbar-nav bg-gradient-primary sidebar  sidebar-dark accordion " id="accordionSidebar">
    ...
    <li class="nav-item <?=$active=="overtime"?'active':($active=="leave"?'active':'')?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#requestCollapse" aria-expanded="true" aria-controls="requestCollapse">
            <i class="fas fa-retweet"></i>
            <span>Request</span></a>
        </a>
        <div id="requestCollapse" class="collapse <?=$active=="overtime"?'show':($active=="leave"?'show':'')?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    ...
    <li class="nav-item <?=$active=="employee"?'active':($active=="position"?'active':'')?>">
        ...
        <div id="employeeCollapse" class="collapse <?=$active=="employee"?'show':($active=="position"?'show':'')?>"" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Employee Management</h6>
                <a class="collapse-item <?=$active=="employee"?'active':''?>"" href="<?=route_to('employee.index')?>">Employee List</a>
